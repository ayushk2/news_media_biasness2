...
function Description(props)
{
    ...
    function handleEvent (event)
    {
         ...
         if(urls.includes(currentUrl))
     {
             ...
             axios.put('/api/goods',{url:currentUrl,rating:stringRating})
         }
     else{
        axios.post('/api/detailspost',{url:currentUrl,ratings:{ left:ratingarray[0],skewsleft:ratingarray[1],center:ratingarray[2],skewsright:ratingarray[3],right:ratingarray[4]}})
        // }
    }
}
...
function postingComments()
{
      if(urls.includes(currentUrl))
      {
        axios.put('/api/goodss',{url:currentUrl,comments:comments})
      }
      else
      {
        axios.post('/api/comments',{url:currentUrl,comments:comments})
      }
}
